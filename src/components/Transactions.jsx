      ...
      <div className="w-4/5 py-10 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-4 lg:gap-2 py-2.5">
          {collection.map((tx) => (
            <div
              key={tx.id}
              className="flex justify-between items-center border border-cyan-500 text-gray-400 w-full shadow-xl shadow-black rounded-md overflow-hidden bg-gray-800 my-2 p-3"
            >
              ...
              <div>
                ...
                <small className="flex flex-row justify-start items-center">
                  ...
                  <a href="#" className="text-cyan-500 mr-2">
